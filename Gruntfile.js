...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    shell: {
      ...
      zip: {
        command: 'ditto -c -k --sequesterRsrc --keepParent <%= OSX_FILENAME_ESCAPED %> release/' + BASENAME + '-' + packagejson.version + '-Mac.zip  --force',
      }
    },
  ...
  grunt.registerTask('release', ['clean:release', 'babel', 'less', 'copy:dev', 'electron', 'shell:sign', 'copy:windows', 'rcedit:exes', 'compress']);
